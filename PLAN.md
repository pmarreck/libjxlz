...
- [ ] Port the next upstream histogram-planning slice beyond fast seed selection: KL-style iterative clustering / reassignment refinement so emitted histogram sets are not limited to one-shot seeds plus greedy merges
