...
- [ ] Port the next upstream histogram-planning slice on top of raw-value clustering: KL-style iterative refinement / reassignment so seed choice is not the last major clustering decision
