...
- [ ] Port the next upstream histogram-planning slice beyond one-shot fixed-seed reassignment: better seed selection / KL-style iterative clustering so emitted histogram sets are not limited to greedy merges plus one reassignment pass
