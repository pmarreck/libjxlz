...
#
# Copied into libjxlz from `~/dotfiles/bin/src/capture.bash` (sha256
# a9b3f51a8dcc862d06cf8beecd2bd7f00547bc37b8a101a265de987f8034400b)
# so GitHub Actions smokes do not depend on a machine-local dotfiles tree.
# Keep this file identical to that source except for this provenance note.
#
