...
BUILD_LOG="${TMPDIR}/cjxlz_tone_mapping_build.log"
RUN_STDERR="${TMPDIR}/cjxlz_tone_mapping_run_stderr.log"
CHECK_STDOUT="${TMPDIR}/cjxlz_tone_mapping_check_stdout.txt"
CHECK_STDERR="${TMPDIR}/cjxlz_tone_mapping_check_stderr.txt"
CHECK_BIN="${TMPDIR}/cjxlz_tone_mapping_info"
CHECK_BUILD_LOG="${TMPDIR}/cjxlz_tone_mapping_check_build.log"
INPUT_PPM="${TMPDIR}/cjxlz_tone_mapping_input.ppm"
ENCODED_JXL="${TMPDIR}/cjxlz_tone_mapping_output.jxl"
ROUNDTRIP_PPM="${TMPDIR}/cjxlz_tone_mapping_roundtrip.ppm"
...
if ! grep -Eq '^203 1.5 1 0.25$' "${CHECK_STDOUT}"; then
