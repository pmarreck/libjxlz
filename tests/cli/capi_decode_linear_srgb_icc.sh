...
BUILD_LOG="${TMPDIR}/capi_decode_linear_srgb_icc_build.log"
RUN_STDERR="${TMPDIR}/capi_decode_linear_srgb_icc_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_decode_linear_srgb_icc"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_decode_linear_srgb_icc.c \
