...
BUILD_LOG="${TMPDIR}/capi_encode_icc_profile_build.log"
RUN_STDERR="${TMPDIR}/capi_encode_icc_profile_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_encode_icc_profile"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_encode_icc_profile.c \
