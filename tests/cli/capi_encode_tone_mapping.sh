...
BUILD_LOG="${TMPDIR}/capi_encode_tone_mapping_build.log"
RUN_STDERR="${TMPDIR}/capi_encode_tone_mapping_run_stderr.log"
CHECK_BIN="${TMPDIR}/capi_encode_tone_mapping"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_encode_tone_mapping.c \
