...
BUILD_LOG="${TMPDIR}/capi_encode_animation_build.log"
RUN_STDERR="${TMPDIR}/capi_encode_animation_run_stderr.log"
CHECK_BIN="${TMPDIR}/capi_encode_animation"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_encode_animation.c \
