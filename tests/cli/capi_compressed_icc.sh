...
BUILD_LOG="${TMPDIR}/capi_compressed_icc_build.log"
RUN_STDERR="${TMPDIR}/capi_compressed_icc_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_compressed_icc"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_compressed_icc.c \
