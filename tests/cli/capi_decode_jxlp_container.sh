...
BUILD_LOG="${TMPDIR}/capi_decode_jxlp_container_build.log"
RUN_STDERR="${TMPDIR}/capi_decode_jxlp_container_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_decode_jxlp_container"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_decode_jxlp_container.c \
