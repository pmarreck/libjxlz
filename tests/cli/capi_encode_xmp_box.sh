...
BUILD_LOG="${TMPDIR}/capi_encode_xmp_box_build.log"
RUN_STDERR="${TMPDIR}/capi_encode_xmp_box_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_encode_xmp_box"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_encode_xmp_box.c \
