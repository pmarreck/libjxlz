...
BUILD_LOG="${TMPDIR}/capi_decode_metadata_boxes_build.log"
RUN_STDERR="${TMPDIR}/capi_decode_metadata_boxes_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_decode_metadata_boxes"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_decode_metadata_boxes.c \
