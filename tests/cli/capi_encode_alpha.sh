...
TMP_C="${TMPDIR}/libjxlz_capi_encode_alpha"
BUILD_LOG="${TMPDIR}/libjxlz_capi_encode_alpha_build.log"
COMPILE_LOG="${TMPDIR}/libjxlz_capi_encode_alpha_compile.log"
RUN_LOG="${TMPDIR}/libjxlz_capi_encode_alpha_run.log"
