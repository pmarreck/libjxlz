...
BUILD_LOG="${TMPDIR}/capi_encode_container_build.log"
RUN_STDERR="${TMPDIR}/capi_encode_container_stderr.txt"
CHECK_BIN="${TMPDIR}/capi_encode_container"
...
if ! clang \
	...
	-Iinclude \
	-Ilib/include \
	tests/cli/capi_encode_container.c \
