...
const fixture = @import("../lib/codec/float_extra_upsampling_fixture.zig");
...
fn check(comptime id: usize) !void {
	...
	const expected = &@field(fixture, "float_" ++ key);
...
test "floating extra upsampling matches all upstream sampling pairs" {
	inline for (0..18) |id| try check(id);
}
