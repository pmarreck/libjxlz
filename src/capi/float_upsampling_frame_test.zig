...
const fixture = @import("../lib/codec/float_upsampling_frame_fixture.zig");
...
test "floating upsampled frames match upstream custom weights filters and rewind" {
	inline for (0..9) |id| try check(id);
}
