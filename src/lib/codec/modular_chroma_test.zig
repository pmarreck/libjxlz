...
const fixture = @import("modular_chroma_fixture.zig");
...
test "modular chroma frames match upstream pixels" {
...
test "modular chroma frame allocation failures release sampled planes" {
