...
pub const codec = struct {
	...
	pub const decode_session = @import("codec/decode_session.zig");
	pub const patches = @import("codec/patches.zig");
...
test {
	...
	_ = @import("codec/color_matrix_test.zig");
	_ = @import("codec/primary_linear_test.zig");
